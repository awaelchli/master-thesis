...
%	\end{enumerate}
	...
	\section{Classic Methods}
		...
		\subsection{Feature Extraction and Matching}
			...
			Furthermore, SIFT is defined based on very low-level image characteristics, which is contrary to how the human brain, the most-sophisticated system for vision we know, works.
