...
%		Otherwise, the reconstruction problem is ambiguous.
	...
	\section{Visual Odometry by Deep Learning}
		...
		\begin{figure}[t]
			\centering
			\includegraphics[width=7cm]{"Introduction/Problem Overview/overview"}
		...
		Supervised learning requires that the true camera poses are known during the learning phase.% for continuous performance evaluation.
