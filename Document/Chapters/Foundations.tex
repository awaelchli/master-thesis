...
%		In this thesis, we are particularly interested in the subset of quaternions called the \emph{unit quaternions}. These are all the quaternions with unit norm, i.e., $\lVert \vectr{q} \rVert = 1$. 
	...
	\section{The Long Short-Term Memory}
		...
		\end{figure}
		The \emph{Long Short-Term Memory (LSTM)} is a version of the RNN that was designed to overcome the vanishing gradient problem described above, and it is also used in this thesis.
		...
		If the sigmoid output is one, all information is let through, and if it is zero, no information passes the gate. 
